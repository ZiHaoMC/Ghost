...
import com.zihaomc.ghost.commands.GhostConfigCommand; // 保留此导入
...
import net.minecraftforge.client.ClientCommandHandler; // 保留此导入
...
public class Ghost {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        if (event.getSide() == Side.CLIENT) {
            ...
            //    注意: GhostBlockCommand.register() 内部注册了事件监听器。
            //    通常事件监听器注册放在 preInit，但这里保持原样，因为它也可能做其他 init 工作。
